...
def show_menu():
    menu_list = ['1- Add new product', '2- Edit product information', '3- Show list', '4- Search by name', '5- Qr Code', '6- Remove a product', '7- shopping from store', '8- Save and Exit']
    for i in menu_list:
        print(i)
...
print(f.renderText('Mehrdad Store'))
